...
La frecuencia en que se eligió cada alternativa en cada ítem puede hacerse de forma numérica o gráfica:
...
El paquete itan también implementa el análisis gráfico de ítems que permite resumir las características técnicas del ítem de manera gráfica, lo que facilita su análisis:
